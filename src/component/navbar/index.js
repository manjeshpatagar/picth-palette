...
const Navbar = () => {
  ...
  useEffect(() => {
    // if (selectedProduct) navigate(`/${selectedProduct}`);
  ...
  return (
    ...
    >
      ...
      <div className="content">
        <RenderContent selectedProduct={selectedProduct} product={tmpProducts.filter(d => d.id === selectedProduct)[0]}
          intervalRef={intervalRef} meshRef={meshRef} />
        {/* {renderContent(tmpProducts.filter(d => d.id === selectedProduct)[0])} */}
      </div>
    </div>
  );
};
